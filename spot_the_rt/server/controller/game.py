...
class Game():
    ...
    def __init__(self, nb_round:int = 47, connected_player:dict = {}, lobby_name:str = "Partie", game_id:int = 1):
    ...
    def _add_connected_player(self, new_connected_player_name:str, new_connected_player:object):
        self.__connected_player[new_connected_player_name] = new_connected_player

    def _del_connected_player(self, connected_player_name:str, connected_player_input:object):
    ...
    def add_player_to_lobby(self, new_player_name:str, new_player_status:bool):
        ...
        self._add_connected_player(new_player_name, new_player)
