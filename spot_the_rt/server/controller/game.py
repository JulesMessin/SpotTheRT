...
class Game():
    ...
    def __init__(self, nb_round:int = 47, connected_player:dict = {}, lobby_name:str = "Partie", game_id:int = 1) -> None:
    ...
    def _del_connected_player(self, connected_player_name:str, connected_player_input:object) -> None:
