...
def main():
    ...
    while True:
        ...
        if request[0]=="1":
            ...
            spot_the_RT_game.quit_game_request(player_pseudo_input=request[1], lobby_name_input=request[2])
        elif request[0]=="5":
            spot_the_RT_game.is_symbol_correct_request(player_pseudo_input=request[1], lobby_name_input=request[2], symbol_input=request[3])
