...
from page_salle import PageFin

class PageJeu(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Spot the RT - EN JEU")
        # J'ai légèrement agrandi la hauteur pour accommoder les 3 rangées confortablement
        self.resize(850, 650) 
    ...
    # Exemple pour voir ce que ça donne avec du texte si pas d'images
